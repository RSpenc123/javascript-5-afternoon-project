...
Movie.prototype.changeRating = function(num){
   this.raiting = (this.raiting + num)/2;
   return this.raiting
}
...
User.prototype.removeSavedPost = function(num){
  let remove = this.savedPosts.findIndex(element => element.id === num)
...
User.prototype.changePostRating = function (num1, num2){
  let change  = this.savedPosts.find(element => element.id === num1)
  change.rating = num2
}
